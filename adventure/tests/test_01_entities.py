...
class TestVehicle:
    ...
    def test_valid_number_plate(self):
        ...
        # e.g: AA-12-34
        assert models.VehicleNumberPlate.validate_number_plate("AA-12-34")
        assert not models.VehicleNumberPlate.validate_number_plate("AA-BB-34")
        assert not models.VehicleNumberPlate.validate_number_plate("12-34-56")
        assert not models.VehicleNumberPlate.validate_number_plate("AA1234")
        assert not models.VehicleNumberPlate.validate_number_plate("AA 12 34")
